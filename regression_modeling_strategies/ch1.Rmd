...
### 2.4.7
locally weighted least squares method (loess) is a non parameteric smoother that. TO perform loess at a given value $X=X$, fit a weighted linear regression around a region at $x$. This is usual done with an interval containing 2/3 of the data. Points are weighted such that data further from $x$ are given less weight then points closer (clearly).